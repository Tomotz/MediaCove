...
- Experimental Google Drive settings under Server Control → Settings: account connection, household cache budget, and saved episodes. Use Cache episode in the Library to add a video with its preferred subtitles. [Setup and limitations](docs/GOOGLE_DRIVE_CACHE.md). Automatic TV cloud fallback remains under development.
...
MediaCove 1.3.12 has one complete
[release page](https://github.com/Tomotz/MediaCove/releases/tag/v1.3.12) for all
platforms:

- [Windows x64 installer](https://github.com/Tomotz/MediaCove/releases/download/v1.3.12/MediaCove-Server-1.3.12-Windows-x64.exe)
- [Linux/macOS x64/ARM64 portable server](https://github.com/Tomotz/MediaCove/releases/download/v1.3.12/MediaCove-Server-1.3.12-Linux-macOS-Portable.tar.gz)
- [Portable-server checksum](https://github.com/Tomotz/MediaCove/releases/download/v1.3.12/MediaCove-Server-1.3.12-Linux-macOS-Portable.tar.gz.sha256)
- [LG webOS Developer Mode package](https://github.com/Tomotz/MediaCove/releases/download/v1.3.12/MediaCove-TV-1.3.12.ipk)
- [Complete SHA-256 manifest](https://github.com/Tomotz/MediaCove/releases/download/v1.3.12/SHA256SUMS.txt)
- [MediaCove 1.3.12 release notes](RELEASE_NOTES_1.3.12.md)
...
Update both the server and LG TV app to 1.3.12. The web player is included in the
...
```powershell
Get-FileHash .\MediaCove-Server-1.3.12-Windows-x64.exe -Algorithm SHA256
```

On Linux, verify the portable archive with its companion file:

```sh
sha256sum -c MediaCove-Server-1.3.12-Linux-macOS-Portable.tar.gz.sha256
```

On macOS:

```sh
shasum -a 256 -c MediaCove-Server-1.3.12-Linux-macOS-Portable.tar.gz.sha256
```
